                    ...
                    <li class="nav-item dropdown notification_dropdown">
                        ...
                        <div class="dropdown-menu rounded dropdown-menu-right">
                            <div id="DZ_W_Notification1" class="widget-media dz-scroll p-3 height380 ps">
                                <ul class="timeline">
                                    @foreach (App\Helpers\Format::getNotifikasi() as $item)
                                        <li>
                                            <a
                                            @if ($item->categories == 'sertifikasi')
                                                href="{{ url('admin/list-sertifikasi') }}"
                                            @endif
                                            >
                                                <div class="timeline-panel">
                                                    ...
                                                    <div class="media-body">
                                                        <h6 class="mb-1">{{ $item->deskripsi }}</h6>
                                                        <small class="d-block">{{ Carbon\Carbon::parse($item->created_at)->format('d M Y') }} - {{ Carbon\Carbon::parse($item->created_at)->format('h i') }}</small>
                                                    </div>
                                                </div>
                                            </a>
                                        </li>
                    ...
                    <li class="nav-item dropdown header-profile">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <form action="{{ route('logout') }}" method="POST" id="myform">
                                @csrf
                                <a href="#" onclick="document.getElementById('myform').submit()" class="dropdown-item ai-icon">
